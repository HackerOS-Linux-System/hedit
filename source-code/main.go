...
var (
	...
	saveBinding = key.NewBinding(key.WithKeys("ctrl+s"))
	quitBinding = key.NewBinding(key.WithKeys("ctrl+q"))
)
...
func initialModel(filename string) model {
	...
	ta.KeyMap.DeleteWordBackward.SetKeys("ctrl+w")
	ta.KeyMap.DeleteWordForward.SetKeys("ctrl+delete")
	ta.KeyMap.DeleteAfterCursor.SetKeys("ctrl+k")
	ta.KeyMap.DeleteBeforeCursor.SetKeys("ctrl+u")
